/**
 * @file aprovacoes-ordens-de-compra.js
 * @description Responsável por renderizar a página de "Aprovar Ordens de Compra" no módulo financeiro,
...
export async function renderAprovacoesOrdensDeCompra() {
      ...
      <div class="page-title">
        <div class="row">
          <div class="col-sm-6 col-12">
            <h2>Financeiro - Aprovar Ordens de Compra</h2>
            <p class="mb-0 text-title-gray">"Relatório com as aprovações de ordens de compra"</p>
          </div>
          <div class="col-sm-6 col-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Aprovar Ordens de Compra</li>
            </ol>
          </div>
        </div>
      </div>
  ...
  /**
   * Exibe um modal contendo os dados dos ordens de compra aprovadas.
   * Inicializa o DataTable para a tabela do modal com botões de exportação.
   * @param {Array} data - Dados dos ordens de compra.
   */
          ...
          <div class="modal-content">
            <div class="modal-header bg-primary text-white">
              <h5 class="modal-title" id="paymentsModalLabel">
                Ordens de Compra Aprovadas - ${fornecedorNome}
              </h5>
  ...
  /**
   * Envia uma requisição POST para buscar os dados dos ordens de compra aprovados.
  ...
  async function consultaAprovacoes() {
    ...
    try {
      ...
      const token = await user.getIdToken();
      const response = await fetch('https://n8n.prod.bhm.tec.br/webhook/voetur/aprovacoes/ordens-de-compra', {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`
...
// Registra a rota para a página de "Aprovar Ordens de Compra"
registerRoute('#aprovacoes-ordens-de-compra', renderAprovacoesOrdensDeCompra);