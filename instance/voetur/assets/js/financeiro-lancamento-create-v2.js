...
export async function renderFinanceiroLancamentoCreateV2() {
  ...
  content.innerHTML = `
    ...
    // Inicializa o Select2 para todos os campos relevantes
    ...
    // Adiciona as validações para cada campo utilizando eventos "change" nos campos Select2
    ...
    AuthService.onAuthChange((user) => {
      if (user) {
        Promise.all([
          ...
          .catch((error) => {
            // Caso ocorra algum erro, exibe uma mensagem informativa
            content.innerHTML = `
              <div class="container-fluid" style="background-color: var(--body-color); color: var(--body-font-color);">
