/**
 * @file vtc-indicadores.js
 * @description Responsável por renderizar a página de "VTC Indicadores",
*             idêntica à Listagem de Lançamentos, mas sob a rota "#vtc-indicadores".
 */
...
export async function renderVtcIndicadores() {
...
registerRoute('#vtc-indicadores', renderVtcIndicadores);